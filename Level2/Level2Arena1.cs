...
public class Level2Arena1 : MonoBehaviour
{
    ...
    IEnumerator Spawn()
    {
        ...
        {
            yield return new WaitForSeconds(spawnRate);
            enemyDog.GetComponent<EnemyDog>().speed *= -1;
            Instantiate(enemyDog, new Vector3(spawnLoc2.position.x, spawnLoc2.position.y, spawnLoc2.position.z), Quaternion.AngleAxis(180, Vector3.forward));
            enemyDog.GetComponent<EnemyDog>().speed *= -1;
        }
